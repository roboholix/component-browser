...
if (enableWatchMode) {
  // Regenerate component metadata when componts or examples change.
  chokidar
...
function getExampleFiles(examplesPath, componentName) {
  ...
  try {
    ...
    console.log(chalk.red(`No examples found for ${componentName}.`)); // eslint-disable-line no-console
  }
...
function writeFile(filepath, content) {
  fs.writeFile(filepath, content, function (err) {
    err
      ...
      : console.log(chalk.green("Component data saved.")); // eslint-disable-line no-console
  });
}
